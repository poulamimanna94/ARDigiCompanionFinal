/*
 * @author : Chahat chugh
 * @description : Native integration with React native
 */
...
export const NativeFunction = {
  ...
  setScreenSharing: NativeModules.NativeMobileSDKBridge.setScreenSharing,
  rotateCamera: NativeModules.NativeMobileSDKBridge.rotateCamera,
};

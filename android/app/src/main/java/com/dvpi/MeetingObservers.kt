...
import com.ardigi.RNEventEmitter.Companion.RN_EVENT_ATTENDEES_JOIN
import com.ardigi.RNEventEmitter.Companion.RN_EVENT_ATTENDEES_LEAVE
import com.ardigi.RNEventEmitter.Companion.RN_EVENT_ATTENDEES_MUTE
import com.ardigi.RNEventEmitter.Companion.RN_EVENT_ATTENDEES_UNMUTE
import com.ardigi.RNEventEmitter.Companion.RN_EVENT_VIDEO_TILE_ADD
import com.ardigi.RNEventEmitter.Companion.RN_EVENT_VIDEO_TILE_REMOVE
...
class MeetingObservers(private val eventEmitter: RNEventEmitter) : RealtimeObserver, VideoTileObserver, AudioVideoObserver, DataMessageObserver {
    ...
    private var audioVideoSessionHandler: AudioVideoSessionHandler? = null

    companion object {
        private const val TAG = "MeetingObservers"
    }

    public fun addAudioVideoSessionHandler(audioVideoSessionHandler: AudioVideoSessionHandler?) {
        this.audioVideoSessionHandler = audioVideoSessionHandler
    ...
    override fun onAudioSessionStarted(reconnecting: Boolean) {
        audioVideoSessionHandler?.onAudioSessionStarted(reconnecting)
    ...
    override fun onAudioSessionStopped(sessionStatus: MeetingSessionStatus) {
        audioVideoSessionHandler?.onAudioSessionStopped(sessionStatus)
        // Not implemented for demo purposes
    }
    ...
    override fun onVideoSessionStarted(sessionStatus: MeetingSessionStatus) {
        audioVideoSessionHandler?.onVideoSessionStarted(sessionStatus)
        // Not implemented for demo purposes
    }
    ...
    override fun onVideoSessionStopped(sessionStatus: MeetingSessionStatus) {
        audioVideoSessionHandler?.onVideoSessionStopped(sessionStatus)
        // Not implemented for demo purposes
    }
